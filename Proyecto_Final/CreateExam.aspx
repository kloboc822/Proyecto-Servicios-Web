			...
			<div id="wrapper">
                ...
                <asp:Panel ID="main" runat="server">
                    <asp:Panel ID="Panel1" class="inner" runat="server">
                        <h1>On boarding data</h1>
						<div class="field half first">
                               <asp:TextBox ID="cod_pruebaTxt" runat="server" placeholder="Exam Code"></asp:TextBox>
						</div>
						<div class="field half">
						    <asp:TextBox ID="nombreTxt" runat="server" placeholder="Exam Name"></asp:TextBox>
						</div>
						<div class="field">
						    <asp:TextBox ID="descripcionTxt" runat="server" placeholder="Exam Description"></asp:TextBox>
						</div>
                           <div class="field half first">
