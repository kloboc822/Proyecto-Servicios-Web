			...
			<div id="wrapper">
				...
				<!-- Footer -->
					<footer id="footer">
						<div class="inner">
							<section>
								<h2>Easy Exams - Deleting a user</h2>
								<form method="post" action="#">
									<div class="field half first">
                                        <asp:TextBox ID="idTxt" runat="server" placeholder="ID"></asp:TextBox>
									</div>
									<ul class="actions">
                                        <asp:Button ID="deleteBtn" runat="server" type= "submit" class="special" Text="Delete User" OnClick="deleteBtn_Click" />
