			...
			<div id="wrapper">
                ...
                <asp:Panel ID="main" runat="server">
                    <asp:Panel ID="Panel1" class="inner" runat="server">
						...
						<div class="field">
                            <asp:GridView ID="PaisesView" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateSelectButton="True" DataKeyNames="cod_pais" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="PaisesView_SelectedIndexChanged">
                                <Columns>
