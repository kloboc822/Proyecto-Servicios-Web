<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IndexPuertas.aspx.cs" Inherits="IndexPuertas" %>
			...
			<div id="wrapper">
                ...
                <asp:Panel ID="main" runat="server">
                    <asp:Panel ID="Panel1" class="inner" runat="server">
                        <h1>Administración de puertas</h1>
						<div class="field">
                            <asp:GridView ID="PuertasView" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateSelectButton="True" DataKeyNames="cod_puerta" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="PuertasView_SelectedIndexChanged" >
                                <Columns>
                                    <asp:BoundField DataField="cod_puerta" HeaderText="cod_puerta" ReadOnly="True" SortExpression="cod_puerta" />
                                </Columns>
                            </asp:GridView>
						    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:VuelosConnectionString2 %>" SelectCommand="SELECT [cod_puerta] FROM [PUERTA]" DeleteCommand="DELETE FROM [PUERTA] where [cod_puerta]=@cod_puerta"></asp:SqlDataSource>
						</div>
                        <br />
